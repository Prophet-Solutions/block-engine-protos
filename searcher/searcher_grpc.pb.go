...
func (c *searcherServiceClient) SubscribeBundleResults(ctx context.Context, in *SubscribeBundleResultsRequest, opts ...grpc.CallOption) (SearcherService_SubscribeBundleResultsClient, error) {
	...
	x := &searcherServiceSubscribeBundleResultsClient{ClientStream: stream}
...
func (x *searcherServiceSubscribeBundleResultsClient) Recv() (*bundle.BundleResult, error) {
	m := new(bundle.BundleResult)
...
func _SearcherService_SubscribeBundleResults_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SearcherServiceServer).SubscribeBundleResults(m, &searcherServiceSubscribeBundleResultsServer{ServerStream: stream})
}
...
func (x *searcherServiceSubscribeBundleResultsServer) Send(m *bundle.BundleResult) error {
