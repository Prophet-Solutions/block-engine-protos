...
var file_bundle_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x10, 0x02, 0x42, 0x39, 0x5a,
	0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x50, 0x72, 0x6f, 0x70,
	0x68, 0x65, 0x74, 0x2d, 0x53, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x2d, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x73, 0x2f, 0x62, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_bundle_proto_goTypes = []any{
	...
	(*packet.Packet)(nil),           // 15: packet.Packet
}
...
func file_bundle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bundle_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Bundle); i {
			case 0:
				return &v.state
			case 1:
		...
		file_bundle_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_bundle_proto_msgTypes[12].Exporter = func(v any, i int) any {
