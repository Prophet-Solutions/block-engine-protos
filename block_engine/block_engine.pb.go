...
import (
	bundle "github.com/Prophet-Solutions/block-engine-protos/bundle"
	packet "github.com/Prophet-Solutions/block-engine-protos/packet"
	shared "github.com/Prophet-Solutions/block-engine-protos/shared"
...
func (x *StartExpiringPacketStreamResponse) GetHeartbeat() *shared.Heartbeat {
	if x != nil {
		return x.Heartbeat
	}
	return nil
...
var file_block_engine_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x50, 0x72, 0x6f, 0x70, 0x68, 0x65, 0x74, 0x2d, 0x53, 0x6f, 0x6c, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2d, 0x65, 0x6e, 0x67, 0x69,
	0x6e, 0x65, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
...
var file_block_engine_proto_goTypes = []any{
	...
	(*shared.Header)(nil),                     // 14: shared.Header
	(*packet.PacketBatch)(nil),                // 15: packet.PacketBatch
	(*bundle.BundleUuid)(nil),                 // 16: bundle.BundleUuid
	(*shared.Heartbeat)(nil),                  // 17: shared.Heartbeat
}
...
func file_block_engine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_block_engine_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_block_engine_proto_msgTypes[13].Exporter = func(v any, i int) any {
