...
var file_shredstream_proto_rawDesc = []byte{
	...
	0x6d, 0x2f, 0x50, 0x72, 0x6f, 0x70, 0x68, 0x65, 0x74, 0x2d, 0x53, 0x6f, 0x6c, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2d, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x73, 0x68, 0x72, 0x65, 0x64, 0x73, 0x74, 0x72,
...
var file_shredstream_proto_goTypes = []any{
	...
	(*shared.Socket)(nil),     // 2: shared.Socket
}
...
func file_shredstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_shredstream_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_shredstream_proto_msgTypes[1].Exporter = func(v any, i int) any {
